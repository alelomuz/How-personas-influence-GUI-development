...
Implementation decisions about layout structure, interaction complexity, feedback timing, and support for assistive technologies implicitly encode assumptions about the intended user population\cite{world2008web}.
...
In the following, we therefore focus on how characteristics of the target user group inform GUI development, not directly on the Design components.
